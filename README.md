...
- Use colors: ansii, 8bit or true color, if your terminal allows.
...
For usage (for now) have a look at the [examples/](examples/), [house/](house/) and also in the code (tests).
